   ...
   <div className="relative w-full py-20 max-md:py-15 bg-[#feede7] overflow-hidden">
      ...
      <div className="mx-auto z-10">
        <div className="text-center mb-8">
          <h2 className="text-4xl md:text-5xl xl:text-6xl font-bold bg-gradient-to-b from-orange-500 to-orange-600 bg-clip-text text-transparent heading-oswald mb-4 px-4 uppercase text-center">
